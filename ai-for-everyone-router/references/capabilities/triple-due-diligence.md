<!-- capability_id: cap.ai-for-everyone.triple-due-diligence | revision: 1 | status: active -->
<!-- 来源: ai-for-everyone/triple-due-diligence/SKILL.md（正文逐字保留） -->
...
**判停条件**：若三项尽调中任一项缺少独立证据（技术仅凭直觉、商业没有财务模型、伦理无人负责评估），不得给出"启动"结论，先把结论降级为"暂缓"，补齐该项后再决策。
...
- 课程面向非技术管理者，讲的是立项前"该不该做"的三维判断框架，不提供任何合规结论或法律意见——真实项目涉及数据、算法与行业监管时，必须另请法务与合规评估，不能以本框架的"伦理尽调通过"替代。
- 课程中的伦理与合规讨论以美国大型企业的监管环境为背景，国内企业的数据安全、个人信息保护与行业准入要求差异较大，覆盖明显不足，落地时需替换为本地的合规清单。
...
- **ML可行性双因素**（cap.ai-for-everyone.ml-feasibility）：三重尽职调查中的技术尽调，建立在双因素框架（概念简单性 × 数据充足性）评估通过的基础上。
- **AI价值三途径**（cap.ai-for-everyone.three-value-drivers）：商业尽调需要量化项目价值，本能力提供"降本/增收/新业务"的量化方法。
- **跨职能头脑风暴**（cap.ai-for-everyone.cross-functional-brainstorming）（v2.5 降级：经来源路由入口可达）：头脑风暴产出候选项目后，用三重尽职调查做立项前的深度评估。
