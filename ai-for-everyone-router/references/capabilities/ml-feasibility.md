<!-- capability_id: cap.ai-for-everyone.ml-feasibility | revision: 1 | status: active -->
<!-- 来源: ai-for-everyone/ml-feasibility/SKILL.md（正文逐字保留） -->
...
**判停条件**：若用户既说不清任务的人类判断时长、也答不出任何数据来源，判定为信息不足，终止本次矩阵定位，先请其明确问题定义，不要勉强给出象限结论。
...
- 课程录制于 2019 年、生成式 AI 大规模普及之前；"概念简单 × 数据充足"针对需要标注 (A, B) 样本的监督学习，2023 年后的主流做法（预训练 + 微调 / 提示工程 / RAG）在数据量与工程路径上已明显不同。
- 课程面向非技术管理者，讲的是可行性判断与协作，不涉及模型选型与实现细节，不应被当作技术方案依据。
- 书中案例以美国大型企业为主，中小企业在数据、算力与人才上的资源约束场景覆盖不足。

---

## 相关能力

- **一秒法则**（cap.ai-for-everyone.one-second-rule）：一秒法则为"概念简单性"维度提供最快的评估工具，双因素框架在其之上再叠加数据充足性。
- **三重尽职调查**（cap.ai-for-everyone.triple-due-diligence）：双因素判断通过后，进入三重尽职调查做技术、商业、伦理的深度评估。（v2.5 降级：经来源路由入口可达）
