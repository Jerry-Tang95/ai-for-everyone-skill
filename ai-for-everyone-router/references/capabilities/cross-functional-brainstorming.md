<!-- capability_id: cap.ai-for-everyone.cross-functional-brainstorming | revision: 1 | status: active -->
<!-- 来源: ai-for-everyone/cross-functional-brainstorming/SKILL.md（正文逐字保留） -->
...
**判停条件**：若三轮头脑风暴产出的候选项目里，没有任何一项同时标注"AI 可行性高"和"业务价值高"，判定本轮无交集，暂停立项，回到第一轮补充缺失的那一方专家，而不是带着半吊子清单往下走。
...
- 课程录制于 2019 年，是 LLM/生成式 AI 大规模普及之前的内容——"AI 能做什么"这个圆的边界在 2023 年后被生成式模型大幅改写，课程举例的"邮件分类""读片"这类候选场景已远不能代表当前可行范围，创意发现需要引入更新的人工智能能力清单。
- 课程中的企业案例以美国大型企业为主，中小企业与国内企业的资源约束、合规环境覆盖不足——案例里"多部门专家坐下来共创"的前提，在编制紧张、业务压力大的中小组织里往往不具备。
- 本能力假设跨职能专家能平等对话、目标一致；现实中部门壁垒与权力结构可能让头脑风暴沦为形式，需先判断本组织是否有真实的协作授权。
...
- **自动化任务而非岗位**（cap.ai-for-everyone.automate-task）（v2.5 降级：经来源路由入口可达）：头脑风暴找到方向后，用任务分解框架把方向拆成具体可执行的任务。
- **三重尽职调查**（cap.ai-for-everyone.triple-due-diligence）（v2.5 降级：经来源路由入口可达）：头脑风暴产出候选项目后，用三重尽职调查做立项前的深度评估。
